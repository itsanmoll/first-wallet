...
const CreateWallet: React.FC = () => {
  ...
  if (wallet.isConnected) {
    return (
      <div className="max-w-2xl mx-auto magic-magic">
        <div className="card magic-magic">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="flex items-center text-sm text-gray-600 hover:text-gray-800 magic-magic"
                  >
            ...
            <button
              onClick={() => navigate('/')}
              className="btn-primary w-full magic-magic"
            >
              Go to Dashboard
            </button>
          </div>
    ...
    <div className="max-w-md mx-auto magic-magic">
      <div className="card text-center magic-magic">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-2 p-4 bg-yellow-50 border border-yellow-200 rounded-lg magic-magic">
